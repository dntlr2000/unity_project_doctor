...
Doctor migration 세부사항은 [Unity Project Doctor 0.2.1 문서](docs/skills/unity-project-doctor.md), one-command 흐름과 Baseline 안전 계약은 [Unity Baseline Verification 0.2.0 문서](docs/skills/unity-baseline-verification.md)를 참고한다.
